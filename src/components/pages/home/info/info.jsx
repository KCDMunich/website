...
const Info = () => (
  <section className="safe-paddings bg-white pysm:py-16-40">
    <div className="container-md">
      ...
      <div className="mt-14 justify-between text-2xl text-primary-1 sm:text-lg">
        ...
        <p className="mt-7">
          ...
          <p className="mt-7">
            <span className="font-bold">Technically competent talks</span>, relevant to the larger community and coming from end-user. 
          </p>
          <p className="mt-7">
            <span className="font-bold">Leading experts </span>from Open Source, DevOps and Cloud Native communities.
            </p>
          <p className="mt-7">
            An <span className="font-bold">exceptional 2-floor venue</span> with enough space to network, join talks and workshops. Great food suiting every taste and, of course, <span className="font-bold">bowling</span>!
        </p>
      </div>
    </div>
  </div>
