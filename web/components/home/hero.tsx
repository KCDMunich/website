...
import {
  YouTubeHeroConsentControl,
  YouTubeHeroMedia,
} from '@/components/privacy/youtube-consent';
  ...
  return (
    <section className="relative min-h-screen overflow-hidden text-white">
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <YouTubeHeroMedia
          videoId={EVENT_CONFIG.archive.heroVideoId}
          title={`Cloud Native Summit Munich ${EVENT_CONFIG.archive.edition} session footage`}
        />
