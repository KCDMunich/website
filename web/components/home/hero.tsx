...
const HERO_VIDEO_SRC = `https://www.youtube.com/embed/${EVENT_CONFIG.archive.heroVideoId}?autoplay=1&mute=1&loop=1&playlist=${EVENT_CONFIG.archive.heroVideoId}&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&iv_load_policy=3&cc_load_policy=0`;
